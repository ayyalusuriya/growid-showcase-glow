      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            <a
              href="mailto:hello@growid.com"
              className="flex items-center gap-2 text-card-foreground/80 hover:text-accent transition-colors"
            >
              <Mail className="w-5 h-5" />
              <span className="hidden sm:inline">hello@growid.com</span>
            </a>
            <a
            ...
            <a
              href="https://instagram.com/growid"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-card-foreground/80 hover:text-accent transition-colors"
            >
              <Instagram className="w-5 h-5" />
              <span className="hidden sm:inline">@growid</span>
            </a>
          </div>
        </div>
