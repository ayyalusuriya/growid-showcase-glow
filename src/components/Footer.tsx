      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            <a href="mailto:growid.offcial25@gmail.com" className="flex items-center gap-2 text-card-foreground/80 hover:text-accent transition-colors">
              <Mail className="w-5 h-5" />
              <span className="hidden sm:inline">growid.official25@gmail.com</span>
            </a>
            <a href="tel:+918072559071" className="flex items-center gap-2 text-card-foreground/80 hover:text-accent transition-colors">
