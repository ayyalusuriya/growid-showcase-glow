...
const portfolioItems: PortfolioItem[] = [
  { image: image1, title: "Vani Bojan", category: "Event", filter: "Events", size: "large" },
  { image: image2, title: "Stage", category: "Event", filter: "Events", size: "tall" },
  { image: image3, title: "Concert", category: "Photography", filter: "Photography", size: "medium" },
  { image: image4, title: "Portrait", category: "Photography", filter: "Photography", size: "wide" },
  { image: image5, title: "Moment", category: "Event", filter: "Events", size: "tall" },
  { image: image6, title: "Hari Charan", category: "Event", filter: "Events", size: "large" },
  { image: image7, title: "Performance", category: "Event", filter: "Events", size: "tall" },
  { image: image8, title: "Concert", category: "Event", filter: "Events", size: "wide" },
